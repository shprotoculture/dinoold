            ...
            .checkout__shipping
                ...
                .chechout__shipping-body
                    .row
                        ...
                        .col-lg-12.p-15
                            .input
                                input(type="text" placeholder="Адрес (улица, дом, квартира) *")
                        ...
                        .col-lg-6.p-15.checkout__submit
                            button(class="button button--submit button--large") Оформить
        .col-lg-6.p-15
            .checkout__payment
...
export default {
    ...
    computed: {
        totalPrice() {
            return this.$store.state.customizer.totalPrice;
        }
    }
}
</script>
